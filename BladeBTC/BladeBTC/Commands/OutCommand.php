            ...
            try {
                ...
                if (empty($out_amount)) {
                    ...
                    $this->replyWithMessage([
                        'text' => "devi impostare un importo dopo il comando /out. l'importo ricevuto dal nostro server era nullo.",
                ...
                $this->replyWithMessage([
                    'text' => "Abbiamo ricevuto un errore durante la richiesta di pagamento.\n" . $e->getMessage() . ". \xF0\x9F\x98\x96",
                    'reply_markup' => $reply_markup,
                    'parse_mode' => 'HTML'
                ]);
            }
